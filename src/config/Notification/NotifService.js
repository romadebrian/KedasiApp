...
export default class NotifService {
  ...
  localNotif(ValTitle, ValMessage, Navigation, Data) {
    // console.log(Navigation);

    const handleNavi = () => {
      NotificationHandler.handleNav(Navigation);
    };
    ...
    PushNotification.localNotification({
      ...
      bigText: ValMessage, // (optional) default: "message" prop
      // subText: "This is a subText", // (optional) default: none
      color: "black", // (optional) default: system default
      vibrate: true, // (optional) default: true
      vibration: 300, // vibration length in milliseconds, ignored if vibrate=false, default: 1000
      tag: "some_tag", // (optional) add tag to message
      group: "kedasiApp", // (optional) add group to message
      ...
      subtitle: ValMessage, // (optional) smaller title below notification title

      /* iOS and Android properties */
      id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: ValTitle, // (optional)
      message: ValMessage, // (required)
      data: Data,
      // userInfo: { screen: "Profile" }, // (optional) default: {} (using null throws a JSON value '<null>' error)
      // OrderID: { screen: "Profile" },
  ...
  // handleNav(Navigate) {
  //   console.log("Log Nav", Navigate);
  //   NotificationHandler.openNotification(Navigate);
  // }
